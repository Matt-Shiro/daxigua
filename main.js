...
window.boot = function() {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'https://cdn.jsdelivr.net/gh/Matt-Shiro/daxigua@master/src/project.js';
        if (jsList) {
...
if (false) {
    ...
    if (isRuntime) {
        require('https://cdn.jsdelivr.net/gh/Matt-Shiro/daxigua@master/src/settings.js');
